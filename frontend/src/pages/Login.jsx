...
export default function Login({ setAuthStatus, switchToRegister }) {
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <h2 style={{ margin: '0', fontSize: '1.625rem', fontWeight: '700', color: '#0f172a' }}>Sign In</h2>
                    <p style={{ margin: '0.4rem 0 0', fontSize: '0.875rem', color: '#64748b' }}>Access your automated task pipeline</p>
                </div>
